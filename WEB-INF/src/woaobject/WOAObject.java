...
public class WOAObject  {
	...
	/**
	 * @param other : the WoaObject with who the collision was done  
	 */
	 ...
	 * @param other : the WoaObject to catch
	 */
	//RevoluteJointDef
	//PrismaticJointDef
	//DistanceJointDef
	 ...
	 * write the object in string with attributes
	 */
	...
	/**
	 * Should be override
	 * custom destroy, is called at the end of {@link #finalize()}
	 */
	 ...
	 * Destroy the object then call localfinalize for customs
	 */
